...
const TituloLotes = () => {
    return (
        <>
            <div className="order-1 flex h-16 items-center gap-5 px-8 md:col-span-4 md:h-auto md:min-w-[353px] md:flex-col md:items-start md:px-12 md:pt-12 lg:col-span-3 lg:min-w-[494px] lg:px-[100px] lg:pt-20">
                ...
                <p className="max-w-[135px] text-[13px] leading-4 text-cafranGray-dark md:max-w-[300px] md:text-sm lg:pb-2 lg:text-base">
