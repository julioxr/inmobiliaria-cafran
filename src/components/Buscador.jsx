    ...
    return (
        <>
            <form action="#" className="relative mt-2 flex justify-center">
                <input
                    className="h-[53px] w-[300px] rounded bg-white p-4 text-xs text-cafranGray-semiDark outline-none lg:w-[422px] lg:text-sm"
                    type="text"
                    placeholder="Buscar por Localidad, Barrio, Calle..."
                />
                <div className="absolute w-[300px] lg:w-[422px]">
